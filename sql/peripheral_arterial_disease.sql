...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (1350310,1331247)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1350310,1331247)
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (2006227,2105451,2105804,2105805,2105446,2006372,2105209,2105210,2105211,2105462,2105388,2105224,2104950)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2006227,2105451,2105804,2105805,2105446,2006372,2105209,2105210,2105211,2105462,2105388,2105224,2104950)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (78838,133857,74747,80509,434822,134741,440508,4266662,73673,440276,193666,444132,197150,138538,139757,443564,4162993,4153882,133566,443677,192606,79914,436640,72566,434880,73580,78097,437657,80482,435364)and invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (2211597,2211596,2211584,2006873)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2211597,2211596,2211584,2006873)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (2002222,2002267,2108323,2108324,2108325)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2002222,2002267,2108323,2108324,2108325)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (2002222,2002267,2108323,2108325,2108034)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2002222,2002267,2108323,2108325,2108034)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (2002187,2107946,2107950,2107951,2107945,2107927,2107964,2107928,2107969,2107966,2107965,2107968,2107967,2107970,2107880,2107882,2107881,2107879,2107859,2107876,2107904,2107889,2107888,2107903,2107902,2107906,2002042,2108014,2108017,2107910,2107909,2107911,2002022,2002191,2108323,2108324,2108001,2107739,2107733,2107717,2108039,2108038,2108037,2108036,2108325,2108035,2107758,2107772,2107773,2107774,2107775,2107755,2107760,2107761,2107752,2107741,2107754,2107753,2107780,2107798)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2002187,2107946,2107950,2107951,2107945,2107927,2107964,2107928,2107969,2107966,2107965,2107968,2107967,2107970,2107880,2107882,2107881,2107879,2107859,2107876,2107904,2107889,2107888,2107903,2107902,2107906,2002042,2108014,2108017,2107910,2107909,2107911,2002022,2002191,2108323,2108324,2108001,2107739,2107733,2107717,2108039,2108038,2108037,2108036,2108325,2108035,2107758,2107772,2107773,2107774,2107775,2107755,2107760,2107761,2107752,2107741,2107754,2107753,2107780,2107798)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (133857,79917,75911,73021,40483816,4199590,434822,134741,201956,74472,77373,4167532,77661,4266662,74150,75652,194229,440913,4170311,75389,4147003,73673,4270698,440276,321726,193666,444132,80269,432798,40490387,40480077,79914,73580,437657,4320025,79113,4053590,444188)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (133857,79917,75911,73021,40483816,4199590,74472,77373,4167532,77661,74150,75652,194229,440913,4170311,75389,4147003,4270698,321726,80269,432798,40490387,40480077,79914,73580,437657,4320025,79113,4053590,444188)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (440198,76509,78524,134732,4345593,437363,4105114,81696,75073,74817,200881,4117413,77637)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (440198,76509,78524,134732,4345593,437363,4105114,81696,75073,74817,200881,4117413,77637)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (318443,315558,321052)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (315558)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (4295155,2313983,44805248,2313982,2313984,44805247)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4295155,2313983,44805248,2313982,2313984,44805247)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (40489833,46237026)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40489833,46237026)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (314659,320827,321119,201956,313223,376938,134442,312939,4301602)and invalid_reason is null
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (314659,320827,321119,201956,313223,376938,134442,312939,4301602)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (3004249,3028737)and invalid_reason is null
...
(
  ...
  FROM @CDM.dbo.PROCEDURE_OCCURRENCE po
...
(
  select po.*, ROW_NUMBER() over (PARTITION BY po.person_id ORDER BY po.procedure_date, po.procedure_occurrence_id) as ordinal
  FROM @CDM.dbo.PROCEDURE_OCCURRENCE po
where po.procedure_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 4)
) C
...
JOIN @CDM.dbo.observation_period OP on P.person_id = OP.person_id and P.start_date >=  OP.observation_period_start_date and P.start_date <= op.observation_period_end_date
...
(
  SELECT co.*, ROW_NUMBER() over (PARTITION BY co.person_id ORDER BY co.condition_start_date, co.condition_occurrence_id) as ordinal
  FROM @CDM.dbo.CONDITION_OCCURRENCE co
  where co.condition_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 36)
) C
...
(
  ...
  FROM @CDM.dbo.MEASUREMENT m
where m.measurement_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 15)
) C

WHERE C.value_as_number < 0.9000
...
WHERE C.value_as_number > 1.4000
-- End Measurement Criteria
...
(
  select m.*, ROW_NUMBER() over (PARTITION BY m.person_id ORDER BY m.measurement_date, m.measurement_id) as ordinal
  FROM @CDM.dbo.MEASUREMENT m
where m.measurement_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 40)
) C

WHERE C.value_as_number > 255.0000
...
INSERT INTO jk4388.dbo.gist_pad (person_id, cohort_start_date, cohort_end_date)
