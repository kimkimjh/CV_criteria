...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (439847,443454)
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (439847,443454)
  and c.invalid_reason is null
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (262,9203,9201)
...
INSERT INTO jk4388.dbo.gist_stroke_narrow (person_id, cohort_start_date, cohort_end_date)
select person_id, start_date, end_date 
