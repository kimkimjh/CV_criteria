...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (201820,442793,443238)
...
LEFT JOIN
(
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (201254,4058243,435216,40484648)
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (40769338,43021173,42539022,46270562)
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @CDM.dbo.CONCEPT where concept_id in (45774751,44785829,43526465,793293)
UNION  select c.concept_id
  from @CDM.dbo.CONCEPT c
  join @CDM.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45774751,44785829,43526465,793293)
  and c.invalid_reason is null
...
INSERT INTO jk4388.dbo.gist_t2d_sglt2 (person_id, cohort_start_date, cohort_end_date)
select person_id, start_date, end_date 
